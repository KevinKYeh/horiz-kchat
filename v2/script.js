...
function myAPI(url) {
    return $.ajax({
        beforeSend: function(request) {
            ...
            request.setRequestHeader("Authorization", "Bearer 25lg8t7q9vabpkwwa795a2zdwsirx2");
        },
        dataType: "json",
...
Chat = {
    info: {
        ...
        bots: ['streamelements', 'streamlabs', 'nightbot', 'moobot', 'fossabot', 'kyaybot', 'serybot', 'playwithviewersbot'],
